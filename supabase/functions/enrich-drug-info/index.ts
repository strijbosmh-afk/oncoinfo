...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `Je bent een oncologisch farmaceutisch expert. Gegeven een medicijnnaam, geef gestructureerde informatie terug over dit oncologisch geneesmiddel.
...
Denk aan: generieke naam, merknamen, medicijnklasse (gebruik een van: IO/ICI, PARPi, ARTA, Chemotherapie, TKI, ADC, Radioligand Therapie, Hormonale Therapie, Anti-hormonale therapie, Combinatietherapie, CDK4/6i, HER2-remmers, Immunotherapie, SERM, Aromataseremmers, SERD, LHRH agonist, Hormoontherapie, ALK-remmer, EGFR-remmer, Angiogeneseremmer, KRAS G12C remmer, G-CSF), werkingsmechanisme, ziektegebieden, toedieningsweg (IV, PO, SC, IM, Intravesicaal), en goedgekeurde indicaties.`;
          ...
          function: {
            ...
            parameters: {
              ...
              properties: {
                ...
                brand_names: { type: 'string', description: 'Comma-separated brand names' },
