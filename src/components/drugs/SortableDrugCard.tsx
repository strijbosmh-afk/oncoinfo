  ...
  if (isCombo) {
    return (
      <div ref={setNodeRef} style={style} className="relative">
        ...
        <Card className={`h-full border border-[#bfd9d7] bg-card dark:border-[#315f5d] hover:border-[#8fc1bd] hover:shadow-sm transition-all cursor-pointer relative group ${isEditMode ? 'pl-10' : ''}`}>
